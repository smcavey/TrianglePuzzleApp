...
public class TrianglePuzzle {
	...
	public TrianglePuzzle() {
		...
		Triangle triangleOne = new Triangle(1, triangleOneLeft, triangleOneRight, triangleOneBottom, false);
		Triangle triangleTwo = new Triangle(2, triangleTwoLeft, triangleTwoRight, triangleTwoBottom, false);
		Triangle triangleThree = new Triangle(3, triangleThreeLeft, triangleThreeRight, triangleThreeBottom, false);
		Triangle triangleFour = new Triangle(4, triangleFourLeft, triangleFourRight, triangleFourBottom, false);
		Triangle triangleFive = new Triangle(5, triangleFiveLeft, triangleFiveRight, triangleFiveBottom, false);
		Triangle triangleSix = new Triangle(6, triangleSixLeft, triangleSixRight, triangleSixBottom, false);
